...
const SKILL_BUNDLE: &[(&str, &[u8])] = &[
    ...
    ("references/cli-recipes.md", include_bytes!("../../../assets/skills/ods/references/cli-recipes.md")),
    ("references/token-economy.md", include_bytes!("../../../assets/skills/ods/references/token-economy.md")),
