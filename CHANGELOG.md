...
- **Normative spec (satellite):** [open-doc-spec/ods-spec#13](https://github.com/open-doc-spec/ods-spec/pull/13) names `ods.toml` as the exclusive workspace marker (`WS-001`), forbids policy keys in document frontmatter (`PLACE-003`), and rewrites the Zero Config-File Guarantee. Root `index.md` is optional navigation only. Tracks [ods#74](https://github.com/open-doc-spec/ods/issues/74) / [ods-spec#12](https://github.com/open-doc-spec/ods-spec/issues/12).
